...
namespace ombarella
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            string shaderPath = Path.Combine(BepInEx.Paths.PluginPath, "Ombarella", "shader");
            string histogramPath = Path.Combine(BepInEx.Paths.PluginPath, "Ombarella", "ombhistogram");
