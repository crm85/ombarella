...
namespace ombarella
{
    public static class Utils
    {
        ...
        {
            if (Singleton<AbstractGame>.Instantiated && Singleton<AbstractGame>.Instance != null && Singleton<AbstractGame>.Instance.InRaid)
            {
                return true;
            }

            GameWorld instance = Singleton<GameWorld>.Instance;
            return (Object)(object)instance != (Object)null && (Object)(object)instance.MainPlayer != (Object)null;
        }
